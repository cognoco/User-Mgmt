...
- Name: User Registration Flow >> shows success message for at least 2 seconds before redirect after registration
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\auth\registration.spec.ts:72:3
...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\auth\registration.spec.ts:88:32
```
...
- paragraph:
  ...
  - link "Sign in":
    - /url: /login
- text: "{ \"isValid\": false, \"errors\": {}, \"values\": { \"userType\": \"private\", \"acceptTerms\": true, \"firstName\": \"Test\", \"lastName\": \"User\", \"email\": \"\", \"password\": \"TestPassword123!\", \"confirmPassword\": \"TestPassword123!\", \"companyName\": \"\", \"position\": \"\", \"industry\": \"\" } }"
- paragraph:
  - text: Already have an account?
  - link "Sign in":
    - /url: /login
