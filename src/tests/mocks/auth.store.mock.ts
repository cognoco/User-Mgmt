...
// Usage: import { createMockAuthStore } from '@/src/tests/mocks/auth.store.mock';
//        const mockStore = createMockAuthStore({ user: { ... } }, { login: vi.fn() });
//        vi.mock('@/lib/stores/auth.store', () => ({ useAuthStore: vi.fn(() => mockStore) }));

import { vi } from 'vitest';
import type { AuthState, AuthResult, MFASetupResponse, MFAVerifyResponse } from '@/src/types/auth';
