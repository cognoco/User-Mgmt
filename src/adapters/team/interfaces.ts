 ...
 * 
 * This file defines the interface for team data providers.
 * Following the adapter pattern, this interface abstracts the data access
 * layer for team management operations, making the core business logic
 * database-agnostic.
 */
 ...
 * Team data provider interface
 * 
 * This interface defines all team management data operations.
