 ...
 * Please use the useAuth hook from @/hooks/auth/use-auth instead.
...
console.log('[DEPRECATED] auth.store.ts is being used. Please migrate to useAuth hook from @/hooks/auth/use-auth');
