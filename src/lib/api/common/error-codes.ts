...
export const SSO_ERROR_CODES = {
  GENERIC_ERROR: 'SSO_GENERAL_001',
  PROVIDER_DENIED: 'SSO_PROVIDER_001',
  INVALID_CONFIGURATION: 'SSO_CONFIG_001',
  FEDERATION_FAILED: 'SSO_FEDERATION_001',
  NETWORK_ERROR: 'SSO_NETWORK_001',
} as const;
...
export const ERROR_STATUS_MAP: Record<ErrorCode, number> = {
  ...
  // SSO
  [SSO_ERROR_CODES.GENERIC_ERROR]: 500,
  [SSO_ERROR_CODES.PROVIDER_DENIED]: 400,
  [SSO_ERROR_CODES.INVALID_CONFIGURATION]: 400,
  [SSO_ERROR_CODES.FEDERATION_FAILED]: 500,
  [SSO_ERROR_CODES.NETWORK_ERROR]: 502,
};
