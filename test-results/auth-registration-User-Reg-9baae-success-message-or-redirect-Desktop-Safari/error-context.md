...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    23 × locator resolved to <button disabled type="submit" data-testid="submit-button" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground shadow hover:bg-primary/90 h-9 px-4 py-2 w-full">Create Account</button>
       - unexpected value "disabled"

    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\auth\registration.spec.ts:27:30
```
