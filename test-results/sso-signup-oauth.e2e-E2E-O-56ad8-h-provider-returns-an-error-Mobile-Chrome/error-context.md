...
- Name: E2E: OAuth SSO Signup Flow >> should show error message if OAuth provider returns an error
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:136:3
...
Call log:
  - waiting for getByRole('button', { name: /sign up with facebook/i })

    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:159:26
```
