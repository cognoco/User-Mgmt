...
- Name: E2E: Business SSO Admin Configuration >> should provide necessary information for IDP setup (e.g., ACS URL, SP Entity ID)
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-admin-config.e2e.test.ts:227:3
...
Call log:
  - waiting for getByRole('switch', { name: /enable sso/i })
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-admin-config.e2e.test.ts:228:11
```
