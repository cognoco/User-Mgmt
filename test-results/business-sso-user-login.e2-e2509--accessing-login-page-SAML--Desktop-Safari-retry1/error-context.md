...
- Name: E2E: Business SSO User Login >> should redirect to IDP when accessing login page (SAML)
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-user-login.e2e.test.ts:38:3
...
============================================================
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-user-login.e2e.test.ts:44:16
```
