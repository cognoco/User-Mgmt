...
- Name: E2E: Business SSO User Login >> should log in user successfully after IDP authentication (OIDC)
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-user-login.e2e.test.ts:88:3
...
waiting for navigation to "/dashboard" until "load"
  ...
  navigated to "http://localhost:3000/login/test-org-oidc"
============================================================
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\business-sso-user-login.e2e.test.ts:109:16
```
