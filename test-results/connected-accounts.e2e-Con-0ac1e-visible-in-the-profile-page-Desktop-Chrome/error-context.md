...
- Name: Connected Accounts (Account Linking) - Profile Page >> Connected Accounts section is visible in the profile page
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\connected-accounts.e2e.test.ts:27:3
...
Locator: getByRole('heading', { name: /connected accounts/i })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: /connected accounts/i })

    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\connected-accounts.e2e.test.ts:30:35
```
