...
- Name: Profile Verification UI >> Rejected status and admin feedback are shown
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:40:3
...
Call log:
  ...
  - waiting for getByText('Profile Verification')
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:43:58
```
