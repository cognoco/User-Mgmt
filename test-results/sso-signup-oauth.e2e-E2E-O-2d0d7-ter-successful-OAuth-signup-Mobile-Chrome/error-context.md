...
- Name: E2E: OAuth SSO Signup Flow >> should create new user and redirect after successful OAuth signup
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:59:3
...
Call log:
  - waiting for getByRole('button', { name: /sign up with github/i })

    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:81:24
```
...
```ts
   ...
   18 |   const POST_SIGNUP_URL = '/dashboard'; // TODO: VERIFY CONFIG: Or /welcome, /profile/setup etc.
   19 |
