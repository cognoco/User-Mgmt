...
- Name: Team Management E2E >> Viewer can only view team info
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\team-management.e2e.test.ts:55:3
...
============================================================
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\team-management.e2e.test.ts:60:16
```
...
- textbox "Email": viewer@example.com
- text: Password
- textbox "Password": viewerpassword
