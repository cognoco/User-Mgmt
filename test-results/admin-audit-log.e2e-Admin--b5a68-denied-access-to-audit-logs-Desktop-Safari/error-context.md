...
- Name: Admin Audit Log E2E >> Non-admin is denied access to audit logs
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\admin\audit-log.e2e.test.ts:45:3
...
============================================================
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\admin\audit-log.e2e.test.ts:51:16
```
