...
- Name: Password Recovery (Forgot Password) Flow >> Shows error or info on invalid/unregistered email
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\auth\password-recovery.e2e.test.ts:17:3
...
Call log:
  - waiting for getByLabel(/email/i)
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\auth\password-recovery.e2e.test.ts:19:37
```
