...
- Name: E2E: OAuth SSO Signup Flow >> should redirect to OAuth provider for signup (e.g., Google)
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:47:3
...
Call log:
  - waiting for getByRole('button', { name: /sign up with google/i })
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\sso-signup-oauth.e2e.test.ts:51:24
```
