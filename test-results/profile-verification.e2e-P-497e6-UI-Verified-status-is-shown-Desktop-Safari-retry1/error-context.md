...
- Name: Profile Verification UI >> Verified status is shown
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:49:3
...
Call log:
  ...
  - waiting for getByText('Profile Verification')
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:52:58
```
