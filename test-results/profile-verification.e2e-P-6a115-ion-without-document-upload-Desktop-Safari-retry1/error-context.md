...
- Name: Profile Verification UI >> User can request verification without document upload
- Location: C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:7:3
...
Call log:
  ...
  - waiting for getByText('Profile Verification')
    ...
    at C:\Dev\Projects\Products\Apps\user-management-reorganized\e2e\profile-verification.e2e.test.ts:11:58
```
